...
public class agendamentoController {
    public void createAgendamento(Connection con) throws SQLException, ParseException {
    ...
    public void listarAgendamento(Connection con) throws SQLException {
    ...
    public void alterarAgendamento(Connection con) throws SQLException, ParseException {
        Scanner input = new Scanner(System.in);
...
public void deletarAgendamento(Connection con) throws SQLException {
        Scanner input = new Scanner(System.in);
