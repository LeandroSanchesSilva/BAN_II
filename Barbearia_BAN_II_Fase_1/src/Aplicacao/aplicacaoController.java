...
public class aplicacaoController {
    public void createAplicacao(Connection con) throws SQLException {
    ...
    public void listarAplicacao(Connection con) throws SQLException {
    ...
    public void alterarAplicacao(Connection con) throws SQLException {
        Scanner input = new Scanner(System.in);
    ...
    public void deletarAplicacao(Connection con) throws SQLException {
        Scanner input = new Scanner(System.in);
