...
public class servicoController {
    ...
    public void listarServico(Connection con) throws SQLException {
    ...
    public void alterarServico(Connection con) throws SQLException {
        Scanner input = new Scanner(System.in);
        ...
        servicoBean sb = new servicoBean(codservico, descricao, valor);
        servicoModel.update(sb, con);
        System.out.println("Servico atualizado com sucesso!");     
    }

    public void deletarServico(Connection con) throws SQLException {
        Scanner input = new Scanner(System.in);
