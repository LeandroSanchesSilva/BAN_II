...
### __1. Observações Iniciais__
  -- O repósitório remoto possui dois diretórios, uma para cada fase do trabalho respectivamente. Optou-se por desenvolver as aplicações com a IDE Netbeans. Foi utilizado o sistema operacional windows, por uma questão de conveniência e maior familiaridade do aluno com o respectivo SO. 
...
#### No windows:
  ...
  3.1) Abra o terminal e execute o servidor por meio do comando -> redis-server;
  
  3.2) Abra um segundo terminal e execute a aplicação cliente por meio do comando -> redis-cli;
